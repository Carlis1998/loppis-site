...
export const weatherCopy: Record<Locale, WeatherCopy> = {
  sv: {
    ...
    packedAway: "Inplastat och undanställt tills solen är tillbaka.",
  ...
  en: {
    ...
    packedAway: "Wrapped up and put away until the sun returns.",
    previewTag: "Preview",
  ...
  de: {
    ...
    packedAway: "Eingepackt und verstaut, bis die Sonne zurückkommt.",
    previewTag: "Vorschau",
